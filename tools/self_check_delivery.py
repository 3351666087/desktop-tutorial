...
REQUIRED_FILES = [
    ...
    "docs/FOUR_PERSON_PRESENTATION_PLAN_ZH.md",
    "docs/SmartClassroom_4Person_Presentation_Plan_ZH.pdf",
    "docs/SmartClassroom_Team_Guide_ZH.pdf",
    "dist/SmartClassroom_Team_Delivery_Pack.zip",
    "docs/SmartClassroom_Port_Connection_Check_ZH.pdf",
    "docs/SmartClassroom_Feature_Logic_Guide_ZH.pdf",
    "docs/TEAM_FEATURE_GUIDE_ZH.md",
    ...
    "docs/CW2_Cover_Sheet_EN.md",
    "docs/CW2_Final_Project_Report_EN.md",
    "docs/CW2_Marking_Criteria_Response_EN.md",
    "docs/CW2_GitHub_Runbook_EN.md",
    "docs/submission/00_Cover_Sheet.pdf",
    "docs/submission/01_Final_Project_Report.pdf",
    "docs/submission/02_Marking_Criteria_Response.pdf",
    "docs/submission/03_GitHub_Runbook.pdf",
    "docs/lmc_submission/01_Project_Description_Report.pdf",
...
def check_optional_commands(checks: list[Check], compile_checks: bool) -> None:
    ...
    py_targets = [
        ...
        "tools/build_cw2_submission_pack.py",
        "tools/build_lmc_submission_pdfs.py",
        "tools/check_ai_backend_runtime.py",
